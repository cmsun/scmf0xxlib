...
public:
    ...
    */
    ...
    { \
        ...
        DMA_DeInit((DMA_Channel_TypeDef *)DMA1_Channelx); \
 \
 ...
 \
        DMA_Init((DMA_Channel_TypeDef *)DMA1_Channelx, &dma_init); \
        DMA_Cmd((DMA_Channel_TypeDef *)DMA1_Channelx, ENABLE); \
 \
    ...
    */
    ...
    { \
        ...
        for(int i = 0; i < size; ++i) \
            buff[i] = (uint16_t)((int16_t)((float)i * rate + 0.5f) << mBitShift); \
    }
