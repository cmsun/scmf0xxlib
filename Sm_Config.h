...
#if defined(DEBUG_VIA_OPENOCD) && defined(DEBUG_VIA_USART)
#error "There is a conflic between openocd and usart!"
#endif
...
/************************外设默认抢断优先级和响应优先级************************/
//GPIO外部中断默认优先级
#define Default_EXTI_NVIC_IRQChannelPriority 0
//定时器中断默认中断优先级
#define Default_TIM_NVIC_IRQChannelPriority 1
//串口中断中断优默认先级
#define Default_USART_NVIC_IRQChannelPriority 2
//RTC时钟中断默认中断优先级
#define Default_RTC_NVIC_IRQChannelPriority 3
